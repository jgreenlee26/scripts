...
// execute: mage hellomafia
func HelloMafia() {
	choices := []Choice{
		// {Item: "Item Thief", Weight: 10},
		// {Item: "Beloved Prince*", Weight: 5},
		// {Item: "Celebrity", Weight: 10},
		// {Item: "Cop", Weight: 10},
		// {Item: "Cop", Weight: 10},
		// {Item: "Cop", Weight: 10},
		// {Item: "Forager", Weight: 10},
		// {Item: "Forager", Weight: 10},
		// {Item: "Methodical Cop", Weight: 10},
		// {Item: "Regular Town", Weight: 5},
		{Item: "Bus Driver", Weight: 20},
		{Item: "Framer", Weight: 20},
		{Item: "Godfather", Weight: 20},
		{Item: "Janitor", Weight: 20},
		{Item: "Saboteur", Weight: 20},
		// {Item: "Traitor", Weight: 10 },
	}
	numPicks := 2

	for i := 0; i < numPicks; i++ {
		chooser, _ := NewChooser(choices...)
		result := chooser.Pick().(string)
		fmt.Println(result)
		// remove choice from array
		for i := len(choices) - 1; i >= 0; i-- {
			if choices[i].Item == result {
